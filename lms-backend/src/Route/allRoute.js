...
const {acceptRenewRequestandUpdateBorrowingDetails, sendNewBookRequest, fineRecieved, vewRenewalRequest, deleteAcceptedRenewalRequests, librarianProfile, librarianProfileUpdate, updateLibrarianProfileImage } = require("../Controller/librarianController");

const router = express.Router();

router.route('/adduser').post(authentication,authorization('admin','librarian'),uploads.single('profileimage'),addUser);
router.route('/displayProfile').get(authentication,displayProfile);
router.route('/updateadminprofile').put(authentication,authorization('admin'),updateAdminProfile);
...
router.route('/librarianprofile').get(authentication,authorization('librarian'),librarianProfile);
router.route('/librarianprofile').put(authentication,authorization('librarian'),librarianProfileUpdate);
router.route('/updatelibrarianprofileimage').put(authentication,authorization('librarian'),uploads.single('image'),updateLibrarianProfileImage);
router.route('/updateadminprofileimage').put(authentication,authorization('admin'),uploads.single('profileimage'),updateAdminProfileImage);
...
router.route('/viewallregisterdlibrarians').get(viewRegisterdLibrarians);
